...
class SyTool():
    ...
    def installPhp7():
        ...
        php7Local = ''.join([syDicts['path.package.local'], '/resources/php7/php-7.1.22.tar.gz'])
        php7Remote = ''.join([syDicts['path.package.remote'], '/php-7.1.22.tar.gz'])
        ...
        php7DirRemote = ''.join([syDicts['path.package.remote'], '/php-7.1.22'])
